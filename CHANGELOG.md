...
## [0.5.0](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/compare/v0.4.0...v0.5.0) (2026-03-11)
...
* add return type annotations to cli_args functions ([#476](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/476)) ([35523ee](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/35523ee5fb16a1eb6916aa154524c5798ad1477b))
...
* **build:** add automated ms.date freshness checking ([#448](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/448)) ([f92ddbc](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/f92ddbcb27027ed6cc4b183d2361d6b8b39e42f7))
...
* **build:** add release artifact signing and SBOM attestation ([#480](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/480)) ([b226e96](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/b226e964e56fa7d27fd308d2a9ca8157e0e9ad35))
...
* fix and deploy dataviewer ([#498](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/498)) ([c922d49](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/c922d49108c5a7603fb7d4b10eab45d1bf7b562e))
...
* **scripts:** add --config-preview and deployment summary to submission scripts ([#499](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/499)) ([4069806](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/4069806c8a97993163aa6411fe036ee74666702a))
...
* **build:** expand CODEOWNERS coverage to critical paths ([#505](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/505)) ([bafade1](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/bafade1012ccde9b3d4a9613884d39e98ef0e2d6))
* **build:** pin Docker base image and pip dependencies with Dependabot coverage ([#497](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/497)) ([d3d7ea4](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/d3d7ea4a507fd0f747c6eccdb1a1f1db4c4f4e45))
* **build:** pin pydantic version and use uv in config schema validation workflow ([#493](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/493)) ([28d823f](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/28d823ff2a8f56d29b9800bcfea7cb497eb2523a))
* **build:** pin uv installer to versioned URL ([#495](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/495)) ([8d8541b](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/8d8541ba736d0478eb0e13637fbbaa0e0e24f06a))
...
* **build:** resolve codecov PR comment suppression ([#523](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/523)) ([5603bd7](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/5603bd73f8c572ffac7d5c078798dfb9ad5cb36a))
* **build:** use npm ci for deterministic frontend dependency install ([#491](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/491)) ([ee8b5d3](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/ee8b5d3219d35f1fddb357e4ddad7a1489bfe37a)), closes [#490](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/490)
...
* **scripts:** pin uv version in OSMO workflow templates ([#500](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/500)) ([7edf13a](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/7edf13a7785f590fb9332f8ed0acc24445a70360))
...
* **workflows:** enable SARIF upload for dependency-pinning scans ([#502](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/502)) ([124cad6](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/124cad65806838398b4fcfc72bedf9c376153061)), closes [#501](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/501)
* **workflows:** remove redundant top-level permissions from codeql-analysis ([#489](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/489)) ([1490fda](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/1490fda6c522eacdba74bde6904fb2b7627a87ce))
...
* **docs:** add bug report response timeline for OSSF report_responses criterion ([#485](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/485)) ([9b26212](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/9b2621273616114d52bbffcda8a49b07500805f4))
* **docs:** add component update process for OpenSSF Silver badge ([#446](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/446)) ([6adc8a2](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/6adc8a27ba2a1cbb430a70deeb579201e1b12969))
* **docs:** add deprecation policy for external interfaces ([#445](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/445)) ([229d5db](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/229d5db57f3f64e40b470d523ec2c81e3aa9b206))
* **docs:** add YAML frontmatter to SUPPORT.md ([#478](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/478)) ([d94c15d](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/d94c15df31afe4ef998c19f646d8e4f8f73ad720)), closes [#347](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/347)
...
* **docs:** create reference hub and migrate script documentation ([#503](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/503)) ([03a31c6](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/03a31c622c588c8b1b41ed2b0b6e9014645ab90f))
...
* **operations:** create operations hub and troubleshooting guide ([#525](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/525)) ([31c7aaa](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/31c7aaae4004b7b9a357fc4460e19b2b97a1347b))
...
* **build:** align Python dependency workflows with uv ([#447](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/447)) ([3102e03](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/3102e03d6e6c844f1130c278b9c53dddf0119e75))
...
* **deps:** bump cryptography from 45.0.7 to 46.0.5 in /src/training ([#506](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/506)) ([a06434e](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/a06434e4493f96d10c64628a0c2ef11f21a66605))
...
* **deps:** bump the common-dependencies group in /src/common with 3 updates ([#507](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/507)) ([db05074](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/db050745e523540577a576e3e9d08eaa68929ff5))
...
* **deps:** bump the github-actions group across 1 directory with 6 updates ([#510](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/510)) ([c334a64](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/c334a64a4f775314a766bc8b0b3334c2a7395ccc))
* **deps:** bump the inference-dependencies group in /src/inference with 5 updates ([#508](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/508)) ([2852ffb](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/2852ffb2edb0e9f8a207656eaf41b6e2d15b47c0))
* **deps:** bump the lerobot-inference-dependencies group in /workflows/azureml with 4 updates ([#511](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/issues/511)) ([b7c5773](https://github.com/Azure-Samples/azure-nvidia-robotics-reference-architecture/commit/b7c5773dd4f570c42b911e07b7da87355a86649a))
